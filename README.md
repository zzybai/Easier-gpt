...
[Easier-GPT 是一个面向 ChatGPT 网页版的 Chrome / Edge Manifest V3 扩展，重点突出三项能力：长对话收藏追踪、结构化 PDF 导出、LaTeX 一键复制。整个扩展仅通过 Content Script 改造页面 DOM，不依赖 ChatGPT 内部 React 状态。](https://github.com/zzybai/Easier-gpt.git)
